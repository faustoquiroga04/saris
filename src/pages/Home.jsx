      ...
      <main className="home">
        ...
        <section className='content__module'>
          <div className="flyer__wrapper">
            <img src='https://framerusercontent.com/images/0buI2ovGgOJLCNZf5UvoXGlp8tQ.png?width=1230&height=1580' alt="flyer" />
        ...
        <section className='section__saris'>
          ...
          <div>
            <strong><h4>Perfected with AI, personalized with care</h4></strong>
          ...
          <div>
            <strong><h4>World-class Medical Professionals & Experiences</h4></strong>
            <p>With elite clinical care, renowned specialists, and profound precision and compassion, our results speak for themselves.</p>
            <ul className="bullet-list indented">
